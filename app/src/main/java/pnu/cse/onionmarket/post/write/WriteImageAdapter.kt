...
class WriteImageAdapter(private val imageCountTextView: TextView)
    ...
    private var imageList = mutableListOf<WriteImageItem>()
    ...
    companion object {
        ...
        val differ = object : DiffUtil.ItemCallback<WriteImageItem>() {
            override fun areItemsTheSame(oldItem: WriteImageItem, newItem: WriteImageItem): Boolean {
                return oldItem.imageId == newItem.imageId
            }

            override fun areContentsTheSame(oldItem: WriteImageItem, newItem: WriteImageItem): Boolean {
